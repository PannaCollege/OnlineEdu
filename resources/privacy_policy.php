...
<body>
        ...
        <h4>Last updated January 22, 2024</h4>
        <p>
This privacy notice for pannacollege ("we," "us," or "our"), describes how and why
we might collect, store, use, and/or share ("process") your information when you use
our services ("Services"), such as when you:<br/>
<ul>
        <li>Visit our website at pannacollege.org, or any website of ours that links to this
                privacy notice</li>
...
us at panna07@gmail.com.
        </p>
        <h3>SUMMARY OF KEY POINTS</h3>
        <p>
                <b><i>This summary provides key points from our privacy notice, but you can find
                ...
                Learn more about personal information you disclose to us.<br/>
                ...
                more about when and with whom we share your personal information.<br/>
                ...
                cybercriminals, or other unauthorized third parties will not be able to defeat our security and improperly collect, access, steal, or modify your information. Learn more
                about how we keep your information safe.<br/>
                ...
                information. Learn more about your privacy rights.<br/>
        ...
        <ol>
                ...
                <li>WHAT LEGAL BASES DO WE RELY ON TO PROCESS YOUR PERSONAL
                        INFORMATION?</li>
                ...
                <li>HOW CAN YOU REVIEW, UPDATE, OR DELETE THE DATA WE COLLECT
                        FROM YOU?</li>
        </ol>
        <h3>1. WHAT INFORMATION DO WE COLLECT?</h3>
        <p>       
<b>Personal information you disclose to us</b>
<i></i><b>In Short:</b> We collect personal information that you provide to us.</i>
...
<p>
<i><b>In Short:</b> We process your information to provide, improve, and administer our
Services, communicate with you, for security and fraud prevention, and to comply
with law. We may also process your information for other purposes with your consent.</i>
...
<ul>
        <li><b>To facilitate account creation and authentication and otherwise manage
                user accounts.</b>We may process your information so you can create and log
                in to your account, as well as keep your account in working order.</li>
        <li><b>To deliver and facilitate delivery of services to the user.</b>We may process
                your information to provide you with the requested service.</li>
        ...
        <li><b>To send administrative information to you.</b>We may process your
                information to send you details about our products and services, changes to
                our terms and policies, and other similar information.</li>
        <li><b>To fulfill and manage your orders.</b>We may process your information to fulfill
                and manage your orders, payments, returns, and exchanges made through the
                Services.</li>
        <li><b>To enable user-to-user communications.</b>We may process your information
                if you choose to use any of our offerings that allow for communication with
                another user.</li>
        <li><b>To save or protect an individual's vital interest.</b>We may process your
                information when necessary to save or protect an individual’s vital interest,
                such as to prevent harm.</li>
</ul>
</p>
<h3>3. WHAT LEGAL BASES DO WE RELY ON TO PROCESS
        YOUR INFORMATION?</h3>
<p>
<i><b>In Short:</b> We only process your personal information when we believe it is necessary
...
<i><b><u>If you are located in the EU or UK, this section applies to you.</u></b></i><br/>
...
such, we may rely on the following legal bases to process your personal information:<br/>
<ul>
        <li><b>Consent.</b>We may process your information if you have given us permission
                ...
                consent.</li>
        <li><b>Performance of a Contract.</b>We may process your personal information when
                ...
                you.</li>
        <li><b>Legal Obligations.</b>We may process your information where we believe it is
                necessary for compliance with our legal obligations, such as to cooperate with
                a law enforcement body or regulatory agency, exercise or defend our legal rights, or disclose your information as evidence in litigation in which we are
                involved.</li>
                <li><b>Vital Interests.</b> We may process your information where we believe it is
...
process your information without your consent, including, for example:<br/>
<ul>
        <li>If collection is clearly in the interests of an individual and consent cannot be
                obtained in a timely way</li>
        <li>For investigations and fraud detection and prevention</li>
        <li>For business transactions provided certain conditions are met</li>
        <li>If it is contained in a witness statement and the collection is necessary to
                assess, process, or settle an insurance claim</li>
        <li>For identifying injured, ill, or deceased persons and communicating with next
                of kin</li>
        <li>If we have reasonable grounds to believe an individual has been, is, or may be
                victim of financial abuse</li>
        <li>If it is reasonable to expect collection and use with consent would compromise
...
<ul>
        ...
        <li><b>When we use Google Maps Platform APIs.</b>We may share your information
                with certain Google Maps Platform APIs (e.g., Google Maps API, Places API).</li>
</ul>
</p>
<h3>5. DO WE USE COOKIES AND OTHER TRACKING
        TECHNOLOGIES?</h3>
<p>       
<i><b>In Short:</b> We may use cookies and other tracking technologies to collect and store
your information.</i><br/>
...
account, we may have access to certain information about you.</i><br/>
...
outlined in this privacy notice unless otherwise required by law.</i><br/>
...
organizational and technical security measures.</i><br/>
...
Services within a secure environment.<br/>
</p>
<h3>9. DO WE COLLECT INFORMATION FROM MINORS?</h3>
<p>
<i><b>In Short:</b> We do not knowingly collect data from or market to children under 18 years of age.</i><br/>
...
<p>
<i><b>In Short:</b> In some regions, such as the European Economic Area (EEA), United Kingdom (UK), Switzerland, and Canada, you have rights that allow you greater access to and control over your personal information. You may review, change, or terminate your account at any time.</i><br/>
...
data protection authority or UK data protection authority.<br/>
...
below or updating your preferences.<br/>
...
requirements.<br/>
<b><u>Cookies and similar technologies:</u></b> Most Web browsers are set to accept cookies
...
could affect certain features or services of our Services.<br/>
...
<h3>12. DO UNITED STATES RESIDENTS HAVE SPECIFIC
        PRIVACY RIGHTS?</h3>
<p>
<i><b>In Short:</b> If you are a resident of California, you are granted specific rights regarding access to your personal information.</i>
...
is not considered to be "selling" of your personal information.<br/>
...
systems (e.g., backups, etc.).<br/>
<b><u>CCPA Privacy Notice</u></b><br/>
...
required to protect against illegal activities.<br/>
<u>Right to be informed — Request to know</u><br/>
...
consumer information that is de-identified in response to a consumer request or to reidentify individual data to verify a consumer request.<br/>
<u>Right to Non-Discrimination for the Exercise of a Consumer’s Privacy Rights</u><br/>
We will not discriminate against you if you exercise your privacy rights.<br/>
<u>Right to Limit Use and Disclosure of Sensitive Personal Information</u><br/>
We do not process consumer's sensitive personal information.<br/>
<u>Verification process</u><br/>
...
information as soon as we finish verifying you.<br/>
<u>Other privacy rights</u><br/>
<ul>
...
request, by email at panna07@gmail.com, or by referring to the contact details at the bottom of this document. If you have a complaint about how we handle your data, we would like to hear from you.
</p>
<h3>13. DO OTHER REGIONS HAVE SPECIFIC PRIVACY RIGHTS?</h3>
<p>
        <i><b>In Short:</b> You may have additional rights based on the country you reside in.</i><br/>
        <b>Australia and New Zealand</b><br/>
        We collect and process your personal information under the obligations and conditions set by Australia's Privacy Act 1988 and New Zealand's Privacy Act 2020 (Privacy Act).<br/>
This privacy notice satisfies the notice requirements defined in both Privacy Acts, in particular: what personal information we collect from you, from which sources, for which purposes, and other recipients of your personal information.<br/>
If you do not wish to provide the personal information necessary to fulfill their
applicable purpose, it may affect our ability to provide our services, in particular:<br/>
<ul>
...
THE DATA WE COLLECT FROM YOU?"<br/>
...
<p>
        ...
        panna07@gmail.com or contact us by post at:<br/>
        PannaCollege<br/>
        United States
</p>
<h3>16. HOW CAN YOU REVIEW, UPDATE, OR DELETE THE DATA WE COLLECT FROM YOU?</h3>
<p>
